...
class PotentialFieldPathPlanning(Node):
    def __init__(self):
        ...
        self.k_a = 1.5  # Attractive force constant
        self.k_r = 1.5  # Repulsive force constant
    ...
    def laser_callback(self, msg):
        ...
        total_velocity.angular.z = attractive_velocity.angular.z + attractive_velocity.linear.x
